...
It was found that results of coloc are sensitive to prior parameters. A program **Enloc** ([ref-2](https://chenh19.github.io/prelim/GGSB_questions_2022/GGSB_Question_5/Question_5-Reference_2.pdf)) is designed to address this problem. Explain its main ideas.  
...
The key parameter of Enloc is called α1. Define the parameter, and explain why it is important in your own language.  
